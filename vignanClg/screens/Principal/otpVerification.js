...
//     setLoading(true);
//     try {
//       const response = await axios.post('http://10.0.2.2:5000/Principal/verifyotp', sendOtp);
...
//     };
//     try {
//       const response = await axios.post('http://10.0.2.2:5000/Principal/resendOtp', sendOtp);
//       if (response.status === 200) {
//         Toast.show({
//           type: 'success',
//           text1: 'Success',
...
const OtpVerification = ({ navigation, route }) => {
  ...
  // Debounce the handleTextChange function to optimize performance
