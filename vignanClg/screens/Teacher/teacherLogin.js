...
const TeacherLogin = () => {
    ...
    const { teachersignIn } = useContext(AuthContext);
    ...
    const handleSignIn = async () => {
        ...
        try {
            const response = await teachersignIn(data.email, data.password);
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.passwordContainer}>
                        <TextInput
                            ...
                            placeholderTextColor="#ffffff"
                            secureTextEntry={!passwordVisible} // Updated to toggle visibility
                    ...
                    <Text style={styles.forgotPassword} onPress={() => navigation.navigate('teacherEamilOtp')}>
                        Forgot password?
                    </Text>
