...
//         navigation.navigate('teacherOtpVerify');
...
//                     <Text style={[styles.buttonText, isLoading && { marginLeft: 10 }]}>Submit</Text>
//                 </TouchableOpacity>

//                 <View style={styles.signInContainer}>
//                     <Text style={styles.signInText}>
//                         If you have an account?{' '}
//                         <Text style={styles.signInLink} onPress={() => navigation.navigate('teacherLogin')}>
//                             Sign in
//                         </Text>
//                     </Text>
//                 </View>
...
//     },
//     signInLink: {
//         color: '#1ABC9C', // Blue color for the sign-in link
...
const TeacherRegistration = ({ navigation }) => {
    ...
    const handleRegister = async () => {
        ...
        try {
            const response = await axios.post('http://10.0.2.2:5000/teacher/create', saveObj)
            if (response.status == 200) {
                ...
                navigation.navigate('teacherOtpVerify', { email: formData?.email });
            }
        } catch (error) {
            setIsLoading(false);
