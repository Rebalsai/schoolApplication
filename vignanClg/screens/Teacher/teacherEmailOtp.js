...
const TeacherEmailOtp = ({ navigation }) => {
    ...
    const handleSendOtp = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://10.0.2.2:5000/Teacher/emailSendOtp', { email });
            ...
            if (response.status === 200) {
                ...
                navigation.navigate('teacherOtpVerify', { email: email });
            }
        } catch (err) {
...
export default TeacherEmailOtp;
